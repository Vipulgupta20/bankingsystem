<?php
   ...
   switch($receiver){
    ...
    break;
          ...
          $sql3= "SELECT * FROM `users` WHERE `Name` ='$sender'";
         ...
         $sql1="UPDATE `users` SET Balance=Balance-$amount where `Name`='$sender'";
         $sql2="UPDATE `users` SET Balance=Balance+$amount where `Name`='$receiver'";
...
<div class="container my-3">
        <h2>Tranfer Money</h2>
        <form method="post" action="/banking/transferr.php">
